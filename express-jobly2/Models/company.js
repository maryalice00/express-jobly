...
class Company {
   ...
   *
   * Optional filters: { minEmployees, maxEmployees, name }
   *
   * Returns [{ handle, name, description, numEmployees, logoUrl }, ...]
   * */
  static async findAll(filters = {}) {
    ...
    // Building the SQL WHERE clause based on the provided filters
    let whereClause = '';
    let values = [];
    ...
    // Removing the trailing "AND" from the WHERE clause
    if (whereClause) {
